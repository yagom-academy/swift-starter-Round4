...
var rowan = BodyCondition()
sitUp.action(&rowan)
rowan.checkCondition()

climbing.action(&rowan)
running.action(&rowan)
dynamicBreak.action(&rowan)
rowan.checkCondition()
