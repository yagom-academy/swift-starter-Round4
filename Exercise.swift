...
var bodyCondition = BodyCondition(upperBodyStrength: 0, lowerBodyStrength: 0, musclarEndurance: 0, fatigue: 0)
...
let longDistance: Exercise = Exercise(name: "오래달리기") {
    bodyCondition.musclarEndurance += Int.random(in: 20...30)
